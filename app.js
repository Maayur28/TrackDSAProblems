...
const app = express();
const sheet = require("./utilities/striverSheet");
...
//   console.log(arr[i].difficulty == "" && arr[i].url);
//   if (
//     i < arr.length &&
//     arr[i].difficulty == "" &&
//     arr[i].url.includes("geeksforgeeks")
//   ) {
//     const $ = await fetchHTML(arr[i].url);
//     if ($) {
//       if (arr[i].url.includes("practice.geeksforgeeks.org")) {
//         let diff = $(".problem-tab__problem-level").text();
//         console.log(arr[i].url, diff);
//       } else if (arr[i].url.includes("www.geeksforgeeks.org")) {
//         let diff = $(".type-post").text();
//         console.log(
//           arr[i].url,
//           diff.substring(
//             diff.indexOf("Difficulty Level :") + 18,
//             diff.indexOf("Last Updated :")
//           )
//         );
//       }
//     }
